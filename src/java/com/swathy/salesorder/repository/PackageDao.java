...
public class PackageDao {
     public static List<ShowData> getAllPackages(){  
        ...
        try{  
            ...
            PreparedStatement ps=con.prepareStatement("select SalesOrder,SalesOrderDate,PackageId,PackageDate from orderdetails inner join  packages using(SalesOrder) ");  
